...
def _generate_thread(video: dict) -> list[str] | None:
    ...
    try:
        ...
        prompt = (
            ...
            f"- Post 5: CTA AGRESIVO al canal YT. Estructura obligatoria:\n"
            f"  1) Frase corta cerrando el caso con moraleja seca\n"
            f"  2) 'El caso completo con imágenes y sentencia en el canal ↓' (o variante)\n"
            f"  3) El link YT al final\n"
            f"  Máx 260 chars. No pierdas al lector: dile EXPLÍCITAMENTE que se suscriba/vea el vídeo.\n\n"
            f"PROHIBIDO:\n"
