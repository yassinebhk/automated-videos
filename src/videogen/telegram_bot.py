...
def _save_snapshot(subs: int, views: int, videos_n: int,
                    platform: str = "youtube") -> None:
    """Añade fila 'channel' a stats_history para tracking futuro.
    platform='youtube_tax' para el canal TaxHack ES."""
    import json as _json, time
    from datetime import datetime
    from pathlib import Path
    hp = Path(__file__).parent.parent.parent / "output" / "stats_history.jsonl"
    hp.parent.mkdir(parents=True, exist_ok=True)
    row = {"platform": platform, "kind": "channel",
...
# 12/09/26: minutos distribuidos (no :00) tras contención scheduler GH Actions.
# Categorías: SHORT · LONG · RRSS · MANT (mantenimiento) · SPECIAL
_SCHEDULE: list[tuple[int, int, str, str, tuple[int, ...]]] = [
    (3,  27, "MANT",    "Meta token refresh",              (6,)),
    (5,  22, "MANT",    "Topics refresh (dias 1,15)",      (0,1,2,3,4,5,6)),
    (6,  17, "SHORT",   "WaitWhy Short (true crime)",      (0,1,2,3,4,5,6)),
    (6,  27, "SPECIAL", "Playlists refresh",               (6,)),
    (6,  47, "MANT",    "Hourly catchup (06-20)",          (0,1,2,3,4,5,6)),
    (7,  12, "SHORT",   "MenteEnCalma ambient",            (0,1,2,3,4,5,6)),
    (7,  15, "MANT",    "TikTok token refresh",            (0,1,2,3,4,5,6)),
    (7,  30, "RRSS",    "Bluesky growth",                  (0,1,2,3,4,5,6)),
    (7,  42, "MANT",    "Daily summary",                   (0,1,2,3,4,5,6)),
    (8,  37, "SHORT",   "TaxHack Short",                   (0,1,2,3,4,5,6)),
    (8,  43, "LONG",    "WaitWhy long-form (dom+mie)",     (2,6)),
    (8,  53, "LONG",    "Tax long-form (weekly)",          (6,)),
    (9,  3,  "RRSS",    "Social boost",                    (0,1,2,3,4,5,6)),
    (9,  8,  "RRSS",    "Newsjack (09+16 UTC)",            (0,1,2,3,4,5,6)),
    (9,  22, "SHORT",   "Legal Short",                     (0,1,2,3,4,5,6)),
    (9,  33, "SPECIAL", "Shorts audit (sabado)",           (5,)),
    (9,  48, "RRSS",    "Narrative post Bluesky",          (0,1,2,3,4,5,6)),
    (10, 15, "RRSS",    "X growth",                        (0,1,2,3,4,5,6)),
    (10, 18, "RRSS",    "Mastodon growth",                 (0,1,2,3,4,5,6)),
    (10, 30, "RRSS",    "Bluesky growth",                  (0,1,2,3,4,5,6)),
    (10, 37, "LONG",    "Legal long-form (weekly)",        (6,)),
    (10, 52, "SPECIAL", "Series start (miercoles)",        (2,)),
    (11, 23, "SHORT",   "Ayudas Short",                    (0,1,2,3,4,5,6)),
    (11, 32, "SPECIAL", "Community poll resolve (lunes)",  (0,)),
    (11, 43, "SHORT",   "IA Autonomos Short",              (0,1,2,3,4,5,6)),
    (12, 33, "LONG",    "Ayudas long-form (weekly)",       (6,)),
    (13, 3,  "RRSS",    "Social boost",                    (0,1,2,3,4,5,6)),
    (13, 17, "SPECIAL", "Weekly longform catchup",         (6,)),
    (13, 26, "SHORT",   "Motor Short",                     (0,1,2,3,4,5,6)),
    (14, 19, "SHORT",   "TiempoAtras (POV) Short",         (0,1,2,3,4,5,6)),
    (14, 30, "RRSS",    "Bluesky growth",                  (0,1,2,3,4,5,6)),
    (14, 52, "LONG",    "Motor long-form (weekly)",        (6,)),
    (15, 18, "RRSS",    "Mastodon growth",                 (0,1,2,3,4,5,6)),
    (15, 33, "SHORT",   "TopRanking Short",                (0,1,2,3,4,5,6)),
    (16, 8,  "RRSS",    "Newsjack",                        (0,1,2,3,4,5,6)),
    (16, 38, "RRSS",    "Narrative post",                  (0,1,2,3,4,5,6)),
    (17, 3,  "RRSS",    "Social boost",                    (0,1,2,3,4,5,6)),
    (17, 30, "MANT",    "TikTok draft reminder",           (0,1,2,3,4,5,6)),
    (18, 30, "RRSS",    "Bluesky growth",                  (0,1,2,3,4,5,6)),
    (18, 42, "SPECIAL", "Community poll create (dom)",     (6,)),
    (20, 18, "RRSS",    "Mastodon growth",                 (0,1,2,3,4,5,6)),
    (21, 3,  "RRSS",    "Social boost",                    (0,1,2,3,4,5,6)),
    ...
    if tt_tok:
        ...
        try:
            ...
            if data:
                ...
                # video.list PAGINADO → todos los vídeos (para total de views real,
                # TikTok no da total de perfil). Newest-first → [:5] = últimos 5.
                from . import analytics as _an
                all_vids = _an.tiktok_all_videos(hdr)
                total_views_tt = sum(int(v.get("view_count") or 0) for v in all_vids)
                vids = all_vids[:5]
                ...
                tt_line = (
                    ...
                    f"   👥 {followers} followers · {videos} videos · "
                    f"{total_views_tt:,}👁 totales · {total_likes} likes\n"
